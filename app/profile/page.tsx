...
const Profile = async () => {
  ...
  const pastEvents = await getHoursUsers(session?.user?.id);
  let hours;
  if (pastEvents) {
      ...
      <div className="col-span-1 space-y-5">
        ...
        <div className="flex flex-col space-y-5 mt-8">
          <Link href="/profile/edit">
            <button className="black_btn w-full">Edit Profile</button>
          </Link>
          <Link href="/myevents">
            <button className="outline_btn w-full">Upcoming Events</button>
          </Link>
        </div>
        <div className="">
          ...
          <div className="flex gap-x-5 mt-3">
            ...
            <HoverCard>
              ...
              <HoverCardContent className="w-40">
                <div>Successfully signed up for an event</div>
              </HoverCardContent>
            </HoverCard>
          </div>
        </div>
